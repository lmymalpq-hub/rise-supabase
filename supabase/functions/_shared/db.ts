...
// Pin la version pour que les Image Transformations fonctionnent correctement
// dans createSignedUrl({ transform: ... }). Avec @2 sans version, esm.sh peut
// servir une version trop ancienne qui ne signe pas les params transform dans
// le token JWT — du coup Supabase ignorait les params en runtime.
